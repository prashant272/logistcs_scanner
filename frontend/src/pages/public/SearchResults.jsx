  ...
  const handleAutoBroadcast = async () => {
    ...
    try {
      const broadcastPayload = {
        ...
        weightRange: searchPayload.type === 'air' ? queryDetails.weight : (searchPayload.type === 'sea' && (searchPayload.seaLoadType === 'LCL' || queryDetails.loadType === 'LCL') ? queryDetails.lclWeightRange : undefined),
        ...
        shipmentDate: queryDetails.shipmentDate || '',
        deliverySpeed: '3-5',
        price: null,
        vendor: null,
        isDirect: true,
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pt-2 items-center">
                      ...
                      <div className="lg:col-span-9 space-y-4">
                        <div className="flex items-center gap-2.5 relative group cursor-pointer w-max">
                          ...
                          {rate.vendor?.activePlan && typeof rate.vendor.activePlan === 'object' && rate.vendor.activePlan.price > 0 && rate.vendor.activePlan.name?.toLowerCase() !== 'vendor lite' && rate.vendor?.planEndDate && new Date(rate.vendor.planEndDate) > new Date() && (
