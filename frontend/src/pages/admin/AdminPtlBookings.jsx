                            ...
                            {bookings.length === 0 ? (
                                ...
                                <tr key={booking._id} className="hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        ...
                                        <div className="text-xs text-slate-500 uppercase tracking-wider font-semibold">{booking.user_role}</div>
                                    </td>
                                    <td className="px-6 py-4">
                                    ...
                                    <td className="px-6 py-4">
                                        ...
                                        <div className="text-[10px] text-slate-400">Base: ₹{booking.base_price || 0}</div>
                                    </td>
                                    <td className="px-6 py-4">
