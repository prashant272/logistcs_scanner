            ...
            {filteredBookings.map((bkg) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`absolute left-0 top-0 bottom-0 w-1 ${bkg.status === 'Accepted' ? 'bg-emerald-500' :
                  ...
                  <div className="flex flex-col lg:flex-row justify-between items-start gap-4 pl-2">
                    ...
                    <div className="flex flex-col lg:items-end justify-between lg:text-right gap-3 lg:border-l lg:border-slate-100 lg:pl-6 w-full lg:w-auto lg:min-w-[220px] shrink-0">
                      ...
                      <div className="flex flex-col lg:items-end gap-2 pt-1">
                        {type === 'direct' && isInitiator ? (
                          ...
                          <div className="text-left lg:text-right space-y-1 bg-slate-50 border border-slate-100/50 p-2.5 rounded-xl">
                            <div className="text-[9px] font-bold text-slate-500">
                              Customer booked at: <span className="text-[#0066FF] font-black">USD {(bkg.price || 0).toLocaleString()}</span>
                            </div>
                            <div className="text-[9px] font-bold text-slate-500">
                        ...
                        <span className={`px-2.5 py-0.5 rounded-lg text-[9px] font-black uppercase tracking-wider border ${bkg.status === 'Accepted' ? 'text-emerald-600 border-emerald-100 bg-emerald-50/50' :
                  ...
                  {type === 'my' && !isInitiator && (
                    <div className="border-t border-slate-50 pt-4 flex flex-wrap justify-end items-center gap-2.5 pl-2">
                      <button
                        ...
                        className={`flex items-center justify-center gap-1.5 text-[10px] font-black px-4 py-2 rounded-xl transition-all cursor-pointer uppercase tracking-wider ${bkg.status === 'Accepted'
                      ...
                      <button
                        ...
                        className={`flex items-center justify-center gap-1.5 text-[10px] font-black px-4 py-2 rounded-xl transition-all cursor-pointer uppercase tracking-wider ${bkg.status === 'Pending'
                      ...
                      <button
                        onClick={() => handleAction(bkg._id, 'Declined')}
                        className={`flex items-center justify-center gap-1.5 text-[10px] font-black px-4 py-2 rounded-xl transition-all cursor-pointer uppercase tracking-wider ${bkg.status === 'Declined'
                ...
                selectedBookingForQuotes.responses
                  ...
                  .map((resp) => {
                    ...
                    return (
                      <div
                        key={resp._id}
                        className={`border rounded-2xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-all ${isAccepted
