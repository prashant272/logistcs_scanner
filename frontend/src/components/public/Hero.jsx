    ...
    return (
        <section className="relative w-full min-h-[500px] lg:min-h-[580px] bg-gradient-to-r from-white via-[#f5f9ff] to-[#e0f0ff] pt-28 pb-28 lg:pb-36 font-sans border-b border-slate-100/50 flex items-center">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none select-none">
                ...
                />
                {/* Horizontal gradient overlay: white on the left for text readability, fading to transparent on the right */}
                <div className="absolute inset-0 bg-gradient-to-r from-white via-white/15 to-transparent z-10" />
            </div>
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div className="lg:col-span-6 space-y-6 text-left animate-fade-in-up">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-[2.75rem] font-black !text-slate-950 leading-[1.15] tracking-tight">
                        ...
                        <p className="!text-slate-800 text-sm font-bold leading-relaxed max-w-lg">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-4">
                            {features.map((f, i) => (
                                <div key={i} className="space-y-2">
                                    ...
                                    <div>
                                        <h4 className="text-xs font-black !text-slate-900 tracking-wide">{f.title}</h4>
                                        <p className="text-[10px] !text-slate-600 font-bold leading-normal mt-0.5">{f.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
