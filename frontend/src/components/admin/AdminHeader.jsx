    ...
    return (
        <header className="bg-white border-b border-slate-100 h-20 flex items-center justify-between px-6 md:px-8 z-10 shrink-0">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-base font-extrabold !text-[#0B1E43] leading-none tracking-tight">Admin Dashboard</h1>
                    <p className="text-[10px] !text-slate-400 mt-1.5 font-bold tracking-wider uppercase">SYSTEM CONTROL PANEL</p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-4 md:gap-5">
                ...
                <div className="relative hidden lg:block w-64">
                    <input
                        type="text"
                        placeholder="Search logs, vendors, orders..."
                        value={searchQuery || ''}
