        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
            <div className="bg-white rounded-3xl w-full max-w-md overflow-hidden shadow-2xl relative">
                <button
                    ...
                    className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 text-slate-500 hover:bg-slate-200 transition-colors disabled:opacity-50"
                >
                    <X size={16} />
                </button>
                ...
                <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-6">
                        <button
                            ...
                            disabled={isSubmitting}
                            className={`p-4 rounded-xl border-2 flex flex-col items-center justify-center gap-2 transition-all ${action === 'broadcast'
                        ...
                        <button
                            ...
                            disabled={isSubmitting}
                            className={`p-4 rounded-xl border-2 flex flex-col items-center justify-center gap-2 transition-all ${action === 'schedule'
                    ...
                    {action === 'schedule' && (
                        <div className="mb-6 animate-in slide-in-from-top-2 duration-200">
                            ...
                            <input
                                ...
                                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-700 focus:outline-none focus:border-purple-600 focus:ring-1 focus:ring-purple-600 transition-all cursor-pointer disabled:opacity-50"
                            />
                        </div>
                    )}
                    ...
                    <button
                        ...
                        disabled={isSubmitting}
                        className={`w-full py-3.5 rounded-xl text-white text-sm font-black tracking-wide uppercase transition-all shadow-lg flex items-center justify-center gap-2 ${action === 'broadcast'
